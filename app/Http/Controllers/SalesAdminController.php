...
class SalesAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells = $this->transactionUtil->getListSellsBySalesman($business_id, $sale_type);
    ...
    public function sales_visit()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells = $this->transactionUtil->getAllSalesVisit();
            ...
            if (! empty(request()->start_date) && ! empty(request()->end_date)) {
                $start = request()->start_date;
                $end = request()->end_date;
                $sells->whereDate('visit_date', '>=', $start)
                            ->whereDate('visit_date', '<=', $end);
                
            }
            // dd($sells);
            if (! empty(request()->input('created_by'))) {
                $sells->where('sales_id', request()->input('created_by'));
                // dd(request()->input('created_by'));
            }
        ...
        return view('sales_admin.sales_visit')
    ...
    public function target_penjualan()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells = $this->transactionUtil->getListSellsRecapBySalesman($business_id, $sale_type);
    ...
    public function create()
    {
        ...
        return view('sales_admin.create')
            ->with(compact(
                'business_details',
                'taxes',
                'walk_in_customer',
    ...
    public function create_visit()
    {
        ...
        return view('sales_admin.create_visit')
            ->with(compact(
                'business_details',
                'taxes',
                'walk_in_customer',
