...
class PenerimaanController extends Controller
{
            ...
            return Datatables::of($purchases)
                ->addColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can('purchase.update')) {
                        $html .= '<li><a href="'.action([\App\Http\Controllers\PenerimaanController::class, 'edit'], [$row->id]).'"><i class="fas fa-edit"></i>'.__('messages.edit').'</a></li>';
                    }
                    if (auth()->user()->can('purchase.delete')) {
                        $html .= '<li><a href="'.action([\App\Http\Controllers\PenerimaanController::class, 'destroy'], [$row->id]).'" class="delete-purchase"><i class="fas fa-trash"></i>'.__('messages.delete').'</a></li>';
                    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('penerimaan')->with('status', $output);
    }
