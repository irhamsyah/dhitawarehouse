            ...
            <div class="col-md-4">
              <div class="form-group">
                {!! Form::label('sales_target', __( 'lang_v1.sales_target' ) . ':') !!} 
                  {!! Form::text('sales_target', !empty($user->sales_target) ? @num_format($user->sales_target) : 0, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.sales_target' ) ]); !!}
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                {!! Form::label('remaining_target', __( 'sales_admin.remaining_target' ) . ':') !!} 
                  {!! Form::text('remaining_target', !empty($user->remaining_target) ? @num_format($user->remaining_target) : 0, ['class' => 'form-control input_number', 'placeholder' => __( 'sales_admin.remaining_target' ) ]); !!}
              </div>
            </div>
