...
@section('content')
    ...
    <section class="content-header no-print">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('Dattar Premi dan Titipan')
            <small></small>
        </h1>
        <!-- <ol class="breadcrumb">
    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('Dattar Premi dan Titipan')])
            @can('purchase.create')
                @slot('tool')
                    <div class="box-tools">
...
@stop
@section('javascript')
    <script src="{{ asset('js/premi.js?v=' . $asset_v) }}"></script>
