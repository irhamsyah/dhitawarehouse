@extends('layouts.app')
@section('title', __('Laporan Kas'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">{{ __('Laporan Kas')}}</h1>
</section>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (collapse) {
        collapse.classList.add('in', 'active', 'show');
    ...
    <div class="row">
        <div class="col-md-12">
           @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => '#', 'method' => 'get', 'id' => 'kas_report_form' ]) !!}
                <div class="col-md-3">
