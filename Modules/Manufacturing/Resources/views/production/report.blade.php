...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-md-3">
            <a href="{{ action([\App\Http\Controllers\ReportController::class, 'getStockReport']) }}?only_mfg=true" class="btn btn-info btn-flat btn-block">
        ...
        @if(session('business.enable_lot_number') == 1)
            <div class="col-md-3">
                <a href="{{ action([\App\Http\Controllers\ReportController::class, 'getLotReport']) }}?only_mfg=true" class="btn btn-success btn-flat btn-block">
        ...
        @if(session('business.enable_product_expiry') == 1)
            <div class="col-md-3">
                <a href="{{ action([\App\Http\Controllers\ReportController::class, 'getStockExpiryReport']) }}?only_mfg=true" class="btn btn-warning btn-flat btn-block">
        ...
        <div class="col-md-3">
            <a href="{{ action([\App\Http\Controllers\ReportController::class, 'itemsReport']) }}?only_mfg=true" class="btn btn-danger btn-flat btn-block">
